...
class StaticSpider(Spider):
    ...
    def __attrs_post_init__(self):
        def _get_fetch(url) -> httpx.Response:
    ...
    def _get_robots_analyzer(self) -> RobotsAnalyzer:
        ...
        return RobotsAnalyzer(http_client=self._http_client, robots_cache=self.config.robots_cache_folder,
    ...
    def _get_static_response(
        ...
        logger.debug(
            'returning static response with url: %s, text: %s and httpx_response: %s', url, text, httpx_response
        )
    ...
    def statistics(self) -> SpiderStatistics:
        return SpiderStatistics(
            ...
            average_fetch_time=self._total_fetch_time / self.request_counter,
