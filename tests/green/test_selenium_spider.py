...
from scalpel.green.selenium_spider import SeleniumSpider, StaticSpider, SeleniumResponse


# noinspection PyProtectedMember
@pytest.fixture(scope='module')
def green_sel_spider():
...
class TestSeleniumSpider:
    ...
    def test_should_do_nothing_if_url_is_already_present_in_one_url_set(
            self, mocker, green_sel_spider, reachable_urls, unreachable_urls, robots_excluded_urls
    ):
        url = 'http://foo.com'
        logger_mock = mocker.patch('logging.Logger.debug')
        green_sel_spider.reachable_urls = reachable_urls
        green_sel_spider.unreachable_urls = unreachable_urls
        green_sel_spider.robots_excluded_urls = robots_excluded_urls
        green_sel_spider._handle_url(url)
